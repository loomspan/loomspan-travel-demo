...
class AirfareFixtureIntegrationTest {
    @Test
    void cleanMigrationProducesCompleteDeterministicAirfareCatalog() {
    ...
    void fixtureIntegrityRejectsRepresentativeCorruptions() {
        ...
        assertThrows(AssertionError.class, () -> AirfareFixtureIntegrityAssertions.assertValid(coverage));
        ...
        assertThrows(AssertionError.class, () -> AirfareFixtureIntegrityAssertions.assertValid(price));

        JdbcTemplate capacity = migratedDatabase();
        capacity.update("UPDATE flight_instance SET available_seats = 7 "
                + "WHERE catalog_key = 'airfare-out-sfo-d1-20270301'");
        assertThrows(AssertionError.class, () -> AirfareFixtureIntegrityAssertions.assertValid(capacity));
        ...
        assertThrows(AssertionError.class, () -> AirfareFixtureIntegrityAssertions.assertValid(timing));
        ...
        assertThrows(AssertionError.class, () -> AirfareFixtureIntegrityAssertions.assertValid(finalArrival));
