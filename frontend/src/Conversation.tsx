...
export function Conversation({trip,disabled,onConfirm}:{trip:Trip;disabled:boolean;onConfirm:(id:string)=>Promise<void>}){
  ...
  return <details className="panel conversation"><summary>Describe a trip change</summary><p>Tell Loomspan what you want to change. Review the exact differences before saving requirements and comparing trips. Booking acceptance remains a separate step.</p>
